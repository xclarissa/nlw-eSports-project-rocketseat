...
export function CreateAddModal() {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="bg-[#2A2634] fixed py-8 px-10 text-white top-1 left-1/2 -translate-x-1/2 translate-y-40 rounded-lg w-[480px] shadow-lg shadow-black/25">
